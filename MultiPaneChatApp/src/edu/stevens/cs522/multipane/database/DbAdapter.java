...
public class DbAdapter {
	...
	private static final String DATABASE_CHATROOM_TABLE = "chatrooms";
	private static final String DATABASE_MESSAGE_TABLE = "messages";
	private static final String DATABASE_PEER_TABLE = "peers";
	...
	public static final String DATABASE_CREATE_MESSAGES = "CREATE TABLE "
			...
			+ MSGLATITUDE + " TEXT NOT NULL, "
			+ MSGLONGITUDE + " TEXT NOT NULL, "
			+ DATE	+ " TEXT NOT NULL, " 
	...
	public static final String DATABASE_CREATE_PEERS = "CREATE TABLE "
			...
			+ SENDERLATITUDE + " TEXT NOT NULL, "
			+ SENDERLONGITUDE + " TEXT NOT NULL," 
			+STREET + " TEXT);";
	...
	public Cursor getAllEntries() {
		...
		return db.query(DATABASE_MESSAGE_TABLE,
						new String[] { ID, TEXT, SENDER, MSGLATITUDE, MSGLONGITUDE, STREET }, null, null, null,null, null);
	}
	...
	public Cursor getAllPeer() {
		return db.query(DATABASE_PEER_TABLE, new String[] { ID, "name",SENDERLATITUDE,SENDERLONGITUDE, STREET }, null,
				null, null, null, null);
	}
	...
	public Cursor getMessgeByPeer(String name) {
		...
		return db.query(DATABASE_MESSAGE_TABLE,
				new String[] { ID, TEXT, SENDER, MSGLATITUDE, MSGLONGITUDE }, whereClause, whereArgs,
				null, null, null);
	}
	...
	public String getNameById(long id) {
		...
		Cursor c = db.query(DATABASE_PEER_TABLE, new String[] { ID, "name", SENDERLATITUDE, SENDERLONGITUDE, STREET },
