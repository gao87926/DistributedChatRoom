package edu.stevens.cs522.chatappmap.contract;
...
public class Contract {
	...
	public static final String SENDERLATITUDE = "senderlatitude";
	public static final String SENDERLONGITUDE = "senderlongitude";
	
	public static final String MSGLATITUDE = "msglatitude";
	public static final String MSGLONGITUDE = "msglongitude";
	...
	public static String getSenderLatitude(Cursor cursor){
		return cursor.getString(cursor.getColumnIndex(SENDERLATITUDE));
	}
	public static void putSenderLatitude(ContentValues values, String latitude){
		values.put(SENDERLATITUDE, latitude);
	}
	
	public static String getSenderLongitude(Cursor cursor){
		return cursor.getString(cursor.getColumnIndex(SENDERLONGITUDE));
	}
	public static void putSenderLongitude(ContentValues values, String longitude){
		values.put(SENDERLONGITUDE, longitude);		
	}
	
	
	public static String getMsgLatitude(Cursor cursor){
		return cursor.getString(cursor.getColumnIndex(MSGLATITUDE));
	}
	public static void putMsgLatitude(ContentValues values, String latitude){
		values.put(MSGLATITUDE, latitude);
	}
	
	public static String getMsgLongitude(Cursor cursor){
		return cursor.getString(cursor.getColumnIndex(MSGLONGITUDE));
	}
	public static void putMsgLongitude(ContentValues values, String longitude){
		values.put(MSGLONGITUDE, longitude);		
	}
	
	public static String getStreet(Cursor cursor){
		return cursor.getString(cursor.getColumnIndex(STREET));
	}
	public static void putStreet(ContentValues values, String street){
